...
declare type QueryDatabaseResponseResults = PickProps<QueryDatabaseResponse, 'results'>;
declare type QueryDatabaseResponseRecord = (typeof QueryDatabaseResponseResults)[number];

// notion.blocks.children.list
declare type ListBlockChildrenResponseResults = PickType<ListBlockChildrenResponse, 'results'>;
